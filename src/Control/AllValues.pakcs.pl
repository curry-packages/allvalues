...
:- block 'AllValues.prim_allValues'(?,?,-,?).
'AllValues.prim_allValues'(Exp,Vals,E0,E) :-
	waitUntilGround(Exp,E0,E1),
	'AllValues.prim_allValues_exec'(Exp,Vals,E1,E).

:- block 'AllValues.prim_allValues_exec'(?,?,-,?).
'AllValues.prim_allValues_exec'(Exp,Vals,E0,E) :-
	hasPrintedFailure
...
:- block 'AllValues.prim_oneValue'(?,?,-,?).
'AllValues.prim_oneValue'(Exp,Val,E0,E) :-
	waitUntilGround(Exp,E0,E1),
	'AllValues.prim_oneValue_exec'(Exp,Val,E1,E).

:- block 'AllValues.prim_oneValue_exec'(?,?,-,?).
'AllValues.prim_oneValue_exec'(Exp,Val,E0,E) :-
	hasPrintedFailure
...
:- block 'AllValues.prim_rewriteAll'(?,?,-,?).
'AllValues.prim_rewriteAll'(Exp,Vals,E0,E) :-
...
:- block 'AllValues.prim_rewriteSome'(?,?,-,?).
'AllValues.prim_rewriteSome'(Exp,Vals,E0,E) :-
        varsInExp(Exp,[],ExpVars),
