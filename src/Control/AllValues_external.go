...
func ExternalControlDot_AllValuesDot_allValues(task *gocurry.Task){
...
func ExternalControlDot_AllValuesDot_rewriteAll(task *gocurry.Task){
    panic("Control.AllValues.rewriteAll: not yet implemented")
}

func ExternalControlDot_AllValuesDot_rewriteSome(task *gocurry.Task){
